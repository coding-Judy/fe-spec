...
describe('Validate TS configs', () => {
  it('Validate eslint-config-colp/typescript', async () => {
  ...
  it('Validate eslint-config-colp/typescript/vue', async () => {
  ...
  it('Validate eslint-config-colp/essential/typescript', async () => {
  ...
  it('Validate eslint-config-colp/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-colp/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-colp/typescript/node', async () => {
