...
describe('Validate JS configs', () => {
  it('Validate eslint-config-colp', async () => {
  ...
  it('Validate eslint-config-colp/es5', async () => {
  ...
  it('Validate eslint-config-colp/vue', async () => {
  ...
  it('Validate eslint-config-colp/essential', async () => {
  ...
  it('Validate eslint-config-colp/essential/es5', async () => {
  ...
  it('Validate eslint-config-colp/essential/react', async () => {
  ...
  it('Validate eslint-config-colp/essential/vue', async () => {
  ...
  it('Validate eslint-config-colp/node', async () => {
